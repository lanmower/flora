...
export default function IngredientsPage() {
  ...
  const filteredIngredients = ingredients.filter(ingredient =>
    ...
    (ingredient.scientificName && ingredient.scientificName.toLowerCase().includes(searchQuery.toLowerCase()))
  );
                          ...
                          <AccordionContent>
                            <ul className="list-disc list-inside text-muted-foreground">
                              {ingredient.properties.map((property, index) => (
                                <li key={index} className="capitalize">{property.replace(/-/g, ' ')}</li>
                              ))}
                            </ul>
                          </AccordionContent>
                        </AccordionItem>
